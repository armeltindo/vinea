...
const MonEspaceActivites = React.lazy(() => import('./pages/MonEspaceActivites'));
...
const MeditationDetailPage = React.lazy(() => import('./pages/MeditationDetailPage'));
    ...
    return (
      <React.Suspense fallback={memberPortalFallback}>
        <Routes>
          ...
          <Route path="/mon-espace/activites" element={<MonEspaceActivites />} />
