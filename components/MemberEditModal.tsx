          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
              ...
              <div className="space-y-1.5 relative">
                ...
                <div className="relative group">
                  <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" size={16} />
                  <input type="text" value={motherSearch} onChange={(e) => { setMotherSearch(e.target.value); setFormData(prev => ({...prev, motherName: e.target.value, motherId: ''})); selectedMotherIdRef.current = ''; setIsMotherDropdownOpen(true); }} onFocus={() => setIsMotherDropdownOpen(true)} onBlur={() => setTimeout(() => setIsMotherDropdownOpen(false), 150)} placeholder="Nom ou rechercher un membre..." className="w-full pl-10 pr-8 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none text-sm font-bold focus:bg-white focus:border-pink-300 transition-all shadow-sm" />
                  {formData.motherId && (
              ...
              <div className="space-y-1.5 relative">
                ...
                <div className="relative group">
                  <Search className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400" size={16} />
                  <input type="text" value={fatherSearch} onChange={(e) => { setFatherSearch(e.target.value); setFormData(prev => ({...prev, fatherName: e.target.value, fatherId: ''})); selectedFatherIdRef.current = ''; setIsFatherDropdownOpen(true); }} onFocus={() => setIsFatherDropdownOpen(true)} onBlur={() => setTimeout(() => setIsFatherDropdownOpen(false), 150)} placeholder="Nom ou rechercher un membre..." className="w-full pl-10 pr-8 py-3 bg-slate-50 border border-slate-200 rounded-2xl outline-none text-sm font-bold focus:bg-white focus:border-blue-300 transition-all shadow-sm" />
                  {formData.fatherId && (
